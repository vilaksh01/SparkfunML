...
void setup()
{
  ...
  model = tflite::GetModel(g_fire_model_data);
...
void loop()
{
  ...
  { // check if 5000ms passed
    ...
    if (mySensor.dataAvailable())
    {
      ...
      input->data.f[0] = ((mySensor.getCO2()) / 1000);
      input->data.f[1] = ((mySensor.getTVOC()) / 1000);
      input->data.f[2] = ((Sensor.readFloatHumidity()) / 100);
      input->data.f[3] = ((Sensor.readTempC()) / 100);
